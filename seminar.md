...
# 1.3 Почему количество документов меньше количества вхождений? Ответ: потому что в одном документе может быть несколько вхождений слова
```
### 2. IPM
